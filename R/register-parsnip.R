register_perpsnip = function() {
    ...
    parsnip::set_dependency("perpsnip", eng = "perpetual", pkg = "perpsnip", mode = "classification")
    ...
    # ---- Censored regression (optional — requires the {censored} package) ----
    if (requireNamespace("censored", quietly = TRUE)) {
        ...
        parsnip::set_dependency("perpsnip", eng = "perpetual", pkg = "censored", mode = "censored regression")
